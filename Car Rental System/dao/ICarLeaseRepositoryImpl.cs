...
namespace Car_Rental_System.dao
{
    ...
    public class ICarLeaseRepositoryImpl : ICarLeaseRepository
    {
        ...
        public int addCar(Vehicle car)
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandText = "INSERT INTO VEHICLE VALUES(@VehicleId, @Make,@Model,@Year,@DailyRate,@Status,@PassengerCapacity,@EngineCapacity)";
            ...
            {
                Console.WriteLine("Car Added UnSuccessful");
            }
        ...
        public List<Vehicle> listAvailableCars()
        {
            ...
            while (reader.Read())
            {
                ...
                car1.DailyRate = (double)(decimal)reader["dailyRate"];
        ...
        public List<Vehicle> getallcars()
        {
            ...
            while (reader.Read())
            {
                ...
                v1.DailyRate = (double)(decimal)reader["dailyRate"];
        ...
        public int updateCustomerDetails(Customer updatec1)
        {
            ...
            {
                throw new CustomerNotFoundException($"Customer with ID {updatec1.CustomerID} not found.");
            }
            cmd.Parameters.Clear();
        ...
        public int addCustomer(Customer customer)
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandText = "INSERT INTO Customer VALUES(@customerId,@firstName,@lastName,@email,@phoneNumber)";
            ...
            if (addProductStatus > 0)
            {
                Console.WriteLine("Customer Added Successful");
            }
            else
            {
                Console.WriteLine("Customer Added UnSuccessful");
            }
            return addProductStatus;
        ...
        public List<Customer> listCustomers()
        {
            ...
            while (reader.Read())
            {
                ...
                customer1.PhoneNumber = (string)reader["phoneNumber"];
        ...
        public int createLease(int leaseID,int vehicleID, int customerID, DateTime startDate, DateTime endDate, string type)
        {

            cmd.Parameters.Clear();
            cmd.CommandText = "INSERT INTO Lease VALUES(@leaseid,@vehicleid,@customerid,@startdate,@enddate,@type)";
        ...
        public int recordPayment(Lease lease)
        {
            ...
            {
                Console.WriteLine("Payment Added Successful");
            }
            else
            {
                Console.WriteLine("Payment Added UnSuccessful");
            }
